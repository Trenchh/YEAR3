...
public class MainMethod {
  public static void main (String argv[]) {
    ...
    Synch.read = new Semaphore(1, true); // read semaphore
    Synch.wrt = new Semaphore(1, true); // write semaphore
    Synch.x = new Semaphore(1,true); // x used as mutual exclusion for manipulating readcount in reader class
    Synch.y = new Semaphore(1,true); // y used as mutual exclusion for manipulating writecount in writer class
    Synch.z = new Semaphore(1,true); // z allows readers to be active in parallel
